...
##### The Dawning of S.P.A's & the frontend frameworks
...
QPT, or **Quick Price Tool** in the expanded version helps Avaya customers quote a mid-market networking design in 3 easy steps. If you have a *Google*, *LinkedIn* or *Facebook* account and are in the mid-market mood for a network then stop by and check it out.
...
The project was conceived in our department so all requirements came mainly from us where my role in the project was to work with our UX team to conceive and engineer the initial application, hire a team of web/Java developers, then lead development efforts to our stated goals.
