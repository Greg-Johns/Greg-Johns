...
<SideScroller 
  ...
  infos={[
    ...
    "Some TV remote concept sketches.",
    "Image describing remote control/TV interface interactions.",
    ...
    "Initial screen for music browser interface. Blank rectangles represent album art.",
    "Vertical scrolling fans media out into an S type curve.",
    "As you scroll the the S curve stretches out to show more of the cover art.",
