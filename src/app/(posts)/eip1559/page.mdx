...
1. **Base Fee**: An algorithmically determined fee that gets burned (removed from circulation)
...
The animation cycles through historical data from May 15th, 2024 (blocks 19,874,197 to 19,874,237).
