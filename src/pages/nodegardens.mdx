...
<Gallery type='gallery_row' dir='genart/ng' images={
  [
    'ngs1',
    'ngs2',
    'ngs3',
...
Now with Ethereum and ERC-721 (NFT's) market places like OpenSea and [ArtBlocks](https://www.artblocks.io/) have helped breath new life int to the generative art movment letting people buy and sell wholy digital assets verifiable on-chain provenance as well help me reconnect to my inner-artist. So it's in this spirit that I've minted this first set on the Ethereum Blockchain using [Manifold Studio](https://studio.manifold.xyz/home) which made it super easy to upload the image files and mint in batch and allows listing on some of the popular NFT marketplaces. This Node Garden series is up on [OpenSea](https://opensea.io/collection/node-gardens), [Rarible](https://rarible.com/collection/0x3f007ef38b77205c681d764ab913a09bae8d0e7f/items) & [Looksrare](https://looksrare.org/collections/0x3f007ef38B77205c681d764AB913A09bAE8d0e7F).

From here I don't have much planed for the sketches and at only 500x500 pixles their not realy suitable for high resolution prints. Regardless, it feels good to get them on chain even if it is more for my memories than anything else. 

So if anyone happens to actually read this and a particual piece resignates with you and you would like to own one reach out and let me know and I'll see about hooking you up.
