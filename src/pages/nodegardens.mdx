...
My interest in computer automation, aka. programming came later, after graduation but both had a earily similar attraction to me. One of the eariest and best known in this genre was [Sol Lewitt](https://en.wikipedia.org/wiki/Sol_LeWitt) who would just write a list of instructions on a piece of paper and give it to another autonomous human to exicute. What you had left ***was*** the art. He beutifully separated the ***idea*** from the ***execution***. For me, computers and code seemed custom made for generative art. 

### Earley experiments with code and art

Growing up as a kid who could draw all the time, played guitar and other instraments, I had a strong connection with art through my hands. I was always in control of physical part of creating. Werking out ideas in code that the computer visualy renders would transform how I thought about art and the role of the artist.

When I first started programming for the web, JavaScript was young and browsers were at war. Flash splash pages were a thing and I somtimes used Flash to build applications for work that I couldn't with just CSS, HTML and JavaScript. I was inspired by some of the Flash based generative work at the time and had fun animating stuff and building small games but Flash was closed sourced that went aganst my hacker mentality also it felt more like a work tool than the generative tool I imagined.

So in 2001, When Ben Fry and Casey Rae started Proce55ing (now just Processing) that was opensource with a quick code/feedback loop it drew me in. Not only was it technically better, it was the projects creative spirit and the efforts of those involved that spoke to me and I would spend many hours beta testing and just playing with the software. As stated on there site: 
...
The sketches above are some my earliest experiments with node farming. Back then my main objective was playful exploration with code art. Of the visual sketches I was looking for anti-symitries in the output. Things that where beautifil but chaotic and counter the controled hand drawnings I grew up making.

# Now the Ethereum blockchain brings us a new kind of digital ownership with ERC-721, better known as non-fungable tokens. NFT marketplaces and projects like [ArtBlocks](https://www.artblocks.io/) have helped breath new life int to the generative art movment as well as awaken sleepy artist in me. So I thought I would mint some of these early renderings to NFT's and get them off my hardrive and on to the blockchain.
