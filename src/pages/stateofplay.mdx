...
#### A New Hope
With the fate of online gaming hanging in the balance a bright young player steps up and sets out on a new path. A path that will take him on an adventure of great invention. A path that will lead young Vitalik to concieve of a trustless & open game server where anyone can play free from these centralized horrors. This world game server would come to be know as Ethereum and balance was restored to online games. Kind of...
